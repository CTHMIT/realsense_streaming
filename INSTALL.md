...
| **3. Install Isaac ROS** | **Run Orin Install Script:**<br>` bash chmod +x src/scripts/setup/install_isaac_ros_client.sh sudo ./src/scripts/setup/install_isaac_ros_client.sh  ` | **Install x86\_64 Debian Packages:**<br>` bash sudo apt-get install -y \ ros-humble-isaac-ros-h264-decoder \ ros-humble-isaac-ros-visual-slam \ ros-humble-nvblox-ros  ` |
| **4. System Config** | **Run Setup Script:**<br>` bash chmod +x src/scripts/setup/initial_setup.sh ./src/scripts/setup/initial_setup.sh  `<br>Select "**orin**" as the machine type. | **Run Setup Script:**<br>` bash chmod +x src/scripts/setup/initial_setup.sh ./src/scripts/setup/initial_setup.sh  `<br>Select "**server**" as the machine type. |
